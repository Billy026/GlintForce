...
/**
 * Class containing functions working with date and time.
 */
class DateUtils {
    // Converts milliseconds into a date
    ...
    // Converts milliseconds into a date with a specified format
    ...
    // Converts a date into its string format
    fun dateToString(date: LocalDate): String {
        val dateFormatter = DateTimeFormatter.ofPattern("dd MMMM yyyy", Locale.UK)
